# app/services/house_calculators/koch.py
import ephem

def calculate_koch_degrees(obs):
    house_degrees = []
    for house_num in range(1, 13):
        planet = ephem.Sun(obs)
        planet.compute(obs)
        cusp_longitude = calculate_koch_cusp_longitude(house_num, obs)
...
def calculate_koch_cusp_longitude(house_num, obs):
