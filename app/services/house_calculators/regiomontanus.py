# app/services/house_calculators/regiomontanus.py
import ephem

def calculate_regiomontanus_degrees(obs):
    house_degrees = []
    for house_num in range(1, 13):
        planet = ephem.Sun(obs)
        planet.compute(obs)
        cusp_longitude = calculate_regiomontanus_cusp_longitude(house_num, obs)
...
def calculate_regiomontanus_cusp_longitude(house_num, obs):
